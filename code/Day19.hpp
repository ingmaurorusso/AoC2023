...
unsigned long day19Part1(std::string_view streamSource, bool sourceIsFilePath);
unsigned long day19Part2(std::string_view streamSource, bool sourceIsFilePath);