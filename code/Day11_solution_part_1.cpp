...
auto day11Part1(std::string_view streamSource, bool sourceIsFilePath)
{
    ...
    const auto manDist = [&nonEmptyRows, nonEmptyCols](const Point g1, const Point g2) {
...
int main()
{
    try {
        ...
        // day11Part1("./11_input_file.txt",true);
