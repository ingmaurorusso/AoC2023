...
unsigned long day03Part1(std::string_view streamSource, bool sourceIsFilePath);
unsigned long day03Part2(std::string_view streamSource, bool sourceIsFilePath);
