...
unsigned long day10Part1(std::string_view streamSource, bool sourceIsFilePath);
unsigned long day10Part2(std::string_view streamSource, bool sourceIsFilePath);