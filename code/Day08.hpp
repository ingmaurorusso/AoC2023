...
unsigned long day08Part1(std::string_view streamSource, bool sourceIsFilePath);
unsigned long day08Part2(std::string_view streamSource, bool sourceIsFilePath);
