...
auto day07Part2(std::string_view streamSource, bool sourceIsFilePath)
{
    ...
    const auto computeCard = [](const char card) {
        ...
        constexpr auto Jack = 1U; // even less than '2' (-> 2)
    ...
    const auto computeHand = [](const HandCards& cards) {
        ...
        auto cardsCopy = cards; // a copy to be modified
        // each 'J' is modified into a different new char.
        unsigned nJs = 0U;
        for (size_t i = 0; i < HandSize; ++i) {
            if (cardsCopy.at(i) == 'J') {
                ++nJs;
                cardsCopy.at(i) = static_cast<char>('A' + nJs); // 'B', 'C', 'D', 'E', or 'F'
            }
        }
        /* if (nJs > 0U) {
            std::cout << "n. J = " << nJs << " for " << CardsToStr(h.first) << std::endl;
        }*/

        t = HandType::Different; // eventually to change

        constexpr auto Five = 5U;
        for (size_t i = 0; i < HandSize; ++i) {
            switch (++(cardsNumber[cardsCopy.at(i)])) {
            case Five:
                t = HandType::Five;
                return t; // ended cards, no 'J' is present, may return.
            case 4U:
                t = HandType::Four;
                break;
        ...
        case HandType::Five:
            [[fallthrough]];
        case HandType::Full:
            // nothing to change. really, for sure already returned above.
            break;
        case HandType::Four:
            if (nJs == 1U) {
                t = HandType::Five;
            } // else: for sure zero 'J's.
            break;
        case HandType::Three:
            switch (nJs) {
            case 2U:
                t = HandType::Five; // better than Full
                break;
            case 1U:
                t = HandType::Four;
                break;
        ...
        case HandType::Pair:
            ...
            case 3U:
                ...
                break;
            case 2U:
                t = HandType::Four; // better than DoublePair
                break;
            case 1U:
                t = HandType::Three;
                break;
        ...
        /* if (nJs > 0U) {
            std::cout << "changed into type " << TypeToStr(t) << std::endl;
        } */
    ...
    const auto handCompare = [&computeCard](const Hand& h1, const Hand& h2) {
        ...
        if (h1.second == h2.second) {
            ...
            for (size_t i = 0U; i < HandSize; ++i) {
                ...
                if (c1 < c2) {
                    // std::cout << "Hand " << CardsToStr(h1.first) << " beats " <<
                    // CardsToStr(h2.first) << std::endl;
                    return true;
                }
                if (c1 > c2) {
                    // std::cout << "Hand " << CardsToStr(h2.first) << " beats " <<
                    // CardsToStr(h1.first) << std::endl;
                    return false;
                }
            }
        }
    ...
    unsigned long res = std::accumulate(
        hands.begin(), hands.end(), zero, [&i](unsigned long acc, const auto& hr) {
            ++i;
...
int main07p2()
{
    try {
        ...
        // day07Part2("./07_input_file.txt",true);
...
Hand n. 2 = KK677 Type DouplePair
Hand n. 3 = T55J5 Type Four
Hand n. 4 = QQQJA Type Four
Hand n. 5 = KTJJT Type Four
Result: 5905

Real input:
Hand n. 1 = 24K3A Type Different
Hand n. 2 = 25QA7 Type Different
Hand n. 3 = 26T97 Type Different
Hand n. 4 = 27648 Type Different
Hand n. 5 = 28A4Q Type Different
Hand n. 6 = 28A6T Type Different
Hand n. 7 = 2965T Type Different
Hand n. 8 = 2T375 Type Different
Hand n. 9 = 2K637 Type Different
Hand n. 10 = 326A7 Type Different
...
Hand n. 990 = 8JJJJ Type Five
Hand n. 991 = 8J88J Type Five
Hand n. 992 = 8J888 Type Five
Hand n. 993 = 99JJ9 Type Five
Hand n. 994 = 99J99 Type Five
Hand n. 995 = TJTJJ Type Five
Hand n. 996 = TJTTT Type Five
Hand n. 997 = QJJQQ Type Five
Hand n. 998 = QQJQQ Type Five
Hand n. 999 = AAJJJ Type Five
Hand n. 1000 = AAJAA Type Five
Result: 252113488
*/
